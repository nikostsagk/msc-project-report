...
The dataset provides circular annotations for the fruits; thus, they were converted to squares with the same width and height. Instead of discarding annotations that exceed the borders of the image, they were clipped to fit the image.
 ...
 \begin{figure}[!htb]
  \centering
  \subfigure[]{
    \includegraphics[width=0.40\textwidth]{figures/ch4/fig1_1.png}
    \label{ch4:fig1_1}
  }
  \subfigure[]{
    \includegraphics[width=0.40\textwidth]{figures/ch4/fig1_2.png}
    \label{ch4:fig1_2}
  }
  
    \subfigure[]{
    \includegraphics[width=0.40\textwidth]{figures/ch4/fig1_3.png}
    \label{ch4:fig1_3}
  }
  \subfigure[]{
    \includegraphics[width=0.40\textwidth]{figures/ch4/fig1_4.png}
    \label{ch4:fig1_4}
  }
...
\vfill
 \begin{table}[!h]
  ...
  \toprule
  	-				&	\textbf{VGG11} & \textbf{VGG13} 	& \textbf{VGG16} 	& \textbf{VGG19}\\
  \midrule
  \multirow{3}{*}{block1}	&	conv3 x64		&	conv3 x64		&	conv3 x64		&	conv3 x64		\\
  					&				&	conv3 x64		&	conv3 x64		&	conv3 x64		\\
  \cmidrule{2-5}
  					&	\multicolumn{4}{c}{maxpool}	\\
  \hline
  \multirow{3}{*}{block2}	&	conv3 x128	&	conv3 x128	&	conv3 x128	&	conv3 x64		\\
  					&				&	conv3 x128	&	conv3 x128	&	conv3 x64		\\
  \cmidrule{2-5}
  					&	\multicolumn{4}{c}{maxpool}	\\
  \hline
  \multirow{4}{*}{block3}	&	conv3 x256	&	conv3 x256	&	conv3 x256	&	conv3 x256	\\
  					&	conv3 x256	&	conv3 x256	&	conv3 x256	&	conv3 x256	\\
  					&				&				&	conv3 x256	&	conv3 x256	\\
  					&				&				&				&	conv3 x256	 \\
  \cmidrule{2-5}
  					&	\multicolumn{4}{c}{maxpool}	\\
  \hline
  \multirow{5}{*}{block4}	&	conv3 x512	&	conv3 x512	&	conv3 x512	&	conv3 x512	\\
